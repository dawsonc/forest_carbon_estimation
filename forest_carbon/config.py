...
PATH_TO_TREE_PREPROCESSING_SPECIES_INFO = "forest_carbon_estimation/forest_carbon/data/tree_species_info.csv"

# Path to the file used in tree-specific biomass estimation
PATH_TO_TAXA_LEVEL_ABG_MODEL_PARAMETERS = "forest_carbon_estimation/forest_carbon/data/taxa_level_abg_model_parameters.csv"
